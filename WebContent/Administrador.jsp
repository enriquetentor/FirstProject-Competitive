...
<head>
	...
	<title>Leaguepedia | Administrador</title>
</head>
<body>
					<!-- Logo -->
			...
			<!-- Contenido -->
			<div class="container">
				<h3 style="padding: 1.5% 1% 1% 1%">Administrador</h3>
			</div>
			<hr style="margin: 0">
			<ul class="nav nav-pills center" id="pills-tab" role="tablist">
			  <li class="nav-item center">
			    <a class="nav-link active" id="pills-alta-tab" data-toggle="pill" href="#pills-alta" role="tab" aria-controls="pills-home" aria-selected="true">Altas</a>
			  </li>
			  <li class="nav-item center">
			    <a class="nav-link" id="pills-baja-tab" data-toggle="pill" href="#pills-baja" role="tab" aria-controls="pills-profile" aria-selected="false">Bajas</a>
			  </li>
			  <li class="nav-item center">
			    <a class="nav-link" id="pills-modify-tab" data-toggle="pill" href="#pills-modify" role="tab" aria-controls="pills-contact" aria-selected="false">Modificaciones</a>
			  </li>
			</ul>
			<div class="tab-content center" id="pills-tabContent">
			  <div class="tab-pane fade show active" id="pills-alta" role="tabpanel" aria-labelledby="pills-alta-tab">1</div>
			  <div class="tab-pane fade" id="pills-baja" role="tabpanel" aria-labelledby="pills-baja-tab">2</div>
			  <div class="tab-pane fade" id="pills-modify" role="tabpanel" aria-labelledby="pills-modify-tab">3</div>
			</div>
