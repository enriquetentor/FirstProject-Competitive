...
<head>
	...
	<title>Leaguepedia | Jugadores</title>
</head>
<body>
...
<%
			...
			<div class="table-wrapper">
				<table class="alt center"> 		
									<tbody>
										...
										<tr>
										  	<td class="textCenter" width='60' style="background-color:#b6cfe5; padding: 0 5px 0 5px">Major Regions</td>
										  	<td width='300' style="padding: 5px 15px 5px 15px;">
										  		<ul class="options">
										  			<%if(!regionGiven.equalsIgnoreCase("")){%>
										  			<li><a href="Jugadores.jsp?region">Todos</a></li>
										  			<%}else{ %>
										  			<li><a>Todos</a></li>
										  			<%} %>
										  		...
										  		%>
										  			<%if(controladorBD.dameJugadoresRegion(region.getNombre()).size()!=0){ %>
											  			<%if(!regionGiven.equalsIgnoreCase(region.getNombre())){%>
											  			<li><a href="Jugadores.jsp?region=<%=region.getNombre()%>"><%=region.getNombre() %></a></li>
											  			<%}else{ %>
			...
			<div class="table-wrapper">
			<table class="alt center thinner" style="margin-bottom: 5%;">
									<thead>
										<tr>
											<th colspan="6" style="text-align: center; color: black"><h5>Visión general</h5></th>
										</tr>
										<tr>
											<th>Nombre</th>
											<th width='325' colspan="2"></th>
									...
									<tbody>
									<%if(regionGiven.equalsIgnoreCase("")){%>
										<%for(int i=0; controladorBD.dameJugadores().size()>i; i++){
										Jugador jugador = controladorBD.dameJugadores().get(i);
										Equipo equipo = controladorBD.dameEquipo(jugador.getCod_equipo()); %>
										<tr>
											<td width='75' rowspan="2" style="text-align: center;"><a href="Jugador.jsp?cod_jugador=<%=jugador.getCod_jugador() %>"><img title="<%=jugador.getApodo() %>"; width=100%; 
											alt="<%=jugador.getApodo() %>" src="images/players/<%=jugador.getCod_jugador() %>.png"></a></td>
											<td width='200' colspan="2" style="padding-left: 15px;"><h6 class="responsiveText" style="margin: 0; padding: 2%">
											<%=jugador.getNombre()%></h6></td>
											<td class="responsiveText" rowspan="2" width='60' style="text-align: center;"><%=jugador.getApodo() %></td>
											<td class="responsiveText" rowspan="2" width='60' style="text-align: center;"><img id="responsiveMiniImageList" src="
										        ...
										        <%} %>
										     " width="25px">&nbsp;<%=jugador.getRol() %></td>
											<td class="responsiveText" rowspan="2" width='60' style="text-align: center;"><%=jugador.getFecha_nacimiento() %></td>										
										</tr>
										<tr>
										  <td width='100' style="text-align: center;"><a href="Equipo.jsp?cod_equipo=<%=jugador.getCod_equipo() %>"><img id="responsiveMiniImageList" class="teamImage-playersList" title="<%=equipo.getNombre() %>"; 
										  alt="<%=equipo.getNombre() %>" src="images/teams/<%=jugador.getCod_equipo() %>.png"></a></td>
										  <td width='100' style="text-align: center;"><img id="responsiveMiniImageList" title="<%=jugador.getNacionalidad() %>"; width=25px; 
										  alt="<%=jugador.getNacionalidad() %>" src="images/countries/<%=jugador.getNacionalidad() %>.png"></td>
										</tr>
										<%} %>
									<%}else{ %>
										<%for(int i=0; controladorBD.dameJugadoresRegion(regionGiven).size()>i; i++){
										Jugador jugador = controladorBD.dameJugadoresRegion(regionGiven).get(i);%>
										<tr>
											<td width='75' rowspan="2" style="text-align: center;"><a href="Jugador.jsp?cod_jugador=<%=jugador.getCod_jugador() %>"><img title="<%=jugador.getApodo() %>"; width=100%; 
											alt="<%=jugador.getApodo() %>" src="images/players/<%=jugador.getCod_jugador() %>.png"></a></td>
											<td width='200' colspan="2" style="padding-left: 15px;"><h6 class="responsiveText" style="margin: 0; padding: 2%">
										...
										<tr>
										  <td width='100' style="text-align: center;"><a href="Equipo.jsp?cod_equipo=<%=jugador.getCod_equipo() %>"><img id="responsiveMiniImageList" class="teamImage-playersList" title=""; 
										  alt="" src="images/teams/<%=jugador.getCod_equipo() %>.png"></a></td>
										  <td width='100' style="text-align: center;"><img id="responsiveMiniImageList" title="<%=jugador.getNacionalidad() %>"; width=25px; 
										  alt="<%=jugador.getNacionalidad() %>" src="images/countries/<%=jugador.getNacionalidad() %>.png"></td>
										</tr>
										<%} %>
